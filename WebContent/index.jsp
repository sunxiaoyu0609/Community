...
<body>
	<div class="body">
		...
		<div id="list">
			<div id="list_wrap">
				...
				<c:forEach var="club" items="${clubList}" varStatus="status">
					<li>
						<div class="club_item">
							<a href="club.jsp?clno=${club.CLno}">
								<img style="width:230px;height:200px;" src="images/clubs/${club.CLno}/thumbnail.jpg">
							</a>
							<div class="club_name" style="text-align:center">|&nbsp;${club.CLname} |</div>
						</div>
					</li>
				</c:forEach>
				</ul>
		...
		<img src="images/comunity.jpg" style="width: 1000px;height: 110px;">
