...
public class CourseDao extends BaseDao {
	...
	public boolean deleteCourse(String Cno) {
		...
		String sql2= "delete from clubscourses where cno=?";
		String sql3= "delete from studentscourses where cno=?";
		try (Connection conn = dataSource.getConnection(); PreparedStatement pstmt = conn.prepareStatement(sql);PreparedStatement pstmt2 = conn.prepareStatement(sql2);PreparedStatement pstmt3 = conn.prepareStatement(sql3)) {
			pstmt2.setString(1, Cno);
			pstmt2.executeUpdate();
			pstmt3.setString(1, Cno);
